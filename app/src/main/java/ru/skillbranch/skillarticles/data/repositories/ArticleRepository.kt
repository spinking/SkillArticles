...
object ArticleRepository {
    ...
    fun allComments(articleId: String, totalCount: Int) =
        CommentsDataFactory(
            itemProvider = ::loadContentsByRange,
            articleId = articleId,
            totalCount = totalCount
        )

    private fun loadContentsByRange(slug: String?, size: Int, articleId: String): List<CommentItemData> {
    ...
    fun sendComment(articleId: String, comment: String, anserToSlug: String?) {
        network.sendMessage(
            articleId, comment, anserToSlug,
...
class CommentsDataFactory(
    ...
    override fun create(): DataSource<String?, CommentItemData> =
        CommentDadaSource(itemProvider, articleId, totalCount)
}

class CommentDadaSource(
    private val itemProvider: (String?, Int, String) -> List<CommentItemData>,
    private val articleId: String,
    private val totalCount: Int
