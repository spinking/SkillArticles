...
/*        subscribeOnDataSource(
    ...
    override fun handleLike() {
        ...
        val msg = if (isLiked.not()) Notify.TextMessage("Mark is liked")
        else {
...
data class ArticleState(
    ...
    val isCommentSaved: Boolean = false,
